...
;;; CL-Forth does not implement AT-XY, KEY?, and PAGE which are the only words in the Facility word set
...
;;; CL-Forth does implement +FIELD, BEGIN-STRUCTURE, CFIELD:, END-STRUCTURE, FIELD:, MS, and TIME&DATE
